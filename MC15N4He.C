...
//Ti
    ...
    double p0                        =       0.361257    ;
    double p1                        =      0.30889   ;
    double p2                        =   0.000501562;
    double Ecm_reaction = p0+p1*Emeas+p2*Emeas*Emeas;
    Ecm_reaction= Ecm_reaction;
    return Ecm_reaction;
}
...
//***************************************
//Derivation target effective width
//***************************************
double derivation_eff_target_width(double Ecm, double deltaEcm, Char_t* fileSP)
{
    double mu = 931.5;
    double m15N = 15 * mu +0.1014 ;    double m4He = 4 * mu + 2.425;
    double mu4He=m4He /(m4He + m15N);
...
double MCsim(Char_t* fileCS,int Nsim[3], double EbeamEntry,double bin_to_E, double Ibeam, int pressure_target,  double target_width,double concentration_target,double timeUT,double  entranceWindow_width, double exitWindow_width, double angle_max_Si, double dist_target_Si, TH2F* distriAngularAlpha, TH2F* distriToFAlpha, TH1F* distriEx_cm){
    ...
    Char_t* fileSRIM[2] ={Form("/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/4He_4He_%iTorr.dat", pressure_target),Form("/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/15N_4He_%iTorr.dat", pressure_target)};
    /*Al window*/
   //Char_t* fileSRIM_window[2] ={"/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/4He_27Al.dat","/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/15O_27Al.dat"};
    /*Au window*/
    Char_t* fileSRIM_window[2] ={"/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/4He_Ti.dat","/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/15N_Ti.dat"};
     std::cout<<Form("/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/sp_srim/15N_4He_%iTorr.dat", pressure_target)<<std::endl;
    for(int i=0;i<2;i++){
...
/*    double exitWindow_width = 0.010; //mm
    ...
    double entranceWindow_width=0.0048;//mm
   
 
    double angle_max_Si = 2;//degree
    double frac_solid_angle = (1-cos(angle_max_Si*3.14/180.))*0.5;
    double acceptance_angular = 0.0012;//1msr in deg <=> *pow(180./3.14,2)
    double dist_target_Si= 343.;//mm
    
    
    //***************************************
    //MC statistics
    //***************************************
    int Nsim[3]={100000,5000,500000};//{100000,1,500000};//reac(100000), beam, cs_azure
    ...
    //***************************************
    Char_t* fileCS = "/Users/chloefougeres/Documents/experiment/experiments_proposed/4He_15O_4He_15O/analysis/azure/results/cs180deg15N.dat";
    Double_t Ecm[25000];Double_t Ex[25000];Double_t CS_diff_theor[25000];
    Double_t N_theor_MC[25000]; Double_t N_theor_renorm[25000];
    int extraction_data = extraction_data_CS(fileCS,Ex, Ecm,  CS_diff_theor);
    ...
    for(int t=0;t<1;t++){
        ...
        simulation_reaction = MCsim(fileCS, Nsim, EbeamEntry,bin_to_E, Ibeam, aivalable_pressure_target[choice_pressure_target], target_width,concentration_target[choice_pressure_target],timeUT, entranceWindow_width, exitWindow_width, angle_max_Si, dist_target_Si , distriAngularAlpha[t], distriToFAlpha[t], distriEx_cm[t]);
